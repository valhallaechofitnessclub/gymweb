  ...
  return (
    <div
      style={{
        ...
        padding: isMobile ? "5rem 1rem 4rem" : "6rem 2rem 6rem",
      }}
    >
      <style>{`
        .info-card {
        ...
        .social-btn-instagram {
          background: linear-gradient(135deg,
            ...
            rgba(193, 53, 132, 0.15) 50%,
            rgba(253, 88, 0, 0.15) 100%
          );
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        >
          <a
            href="https://www.instagram.com/valhallaecho_fitness_club/"
            target="_blank"
          ...
          <a
            href="https://www.facebook.com/Valhallaechoclub"
            target="_blank"
            rel="noopener noreferrer"
